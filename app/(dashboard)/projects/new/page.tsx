      ...
      <div className="bg-white dark:bg-[#0d0d21] rounded-2xl border border-gray-200 dark:border-gray-800 overflow-hidden shadow-sm">
        ...
        <div className="px-6 py-5 border-b border-gray-100 dark:border-gray-800">
          <div className="flex items-center gap-3">
            ...
            >
              <FolderKanban className="w-5 h-5" style={{ color: form.color }} />
            </div>
            <div>
              <h1 className="text-lg font-extrabold text-gray-900 dark:text-white">New Project</h1>
              <p className="text-xs text-gray-400">Create a new workspace project</p>
            </div>
          </div>
        </div>
